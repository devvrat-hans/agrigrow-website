...
export function ChatWindow({
  ...
  const [_conversationId, _setConversationId] = useState<string | null>(
  ...
  return (
    <div className={cn('flex flex-col h-full', className)}>
      ...
      {/* Input Section - Fixed at bottom with safe area support */}
      <div 
        className={cn(
          ...
          'mb-16 md:mb-0' // Space for mobile bottom nav
        )}
      >
        <ChatInput
          onSend={sendMessage}
