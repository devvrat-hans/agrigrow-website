    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {showChat && (
        <div className="fixed inset-0 z-50 flex flex-col bg-background">
          ...
          {/* Chat Content */}
          <div className="flex-1 flex flex-col min-h-0 pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0">
            {chatViewMode === 'history' ? (
              <ChatHistoryList
          ...
          {/* Mobile Bottom Navigation inside chat overlay */}
          <MobileBottomNav />
        </div>
      )}

      {/* Floating Action Button for Chat - Hidden on desktop when chat actions in header */}
      {!showChat && (
        <button
          onClick={toggleChat}
          className={cn(
